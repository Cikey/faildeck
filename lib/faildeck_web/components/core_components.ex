defmodule FaildeckWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FaildeckWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FaildeckWeb.Gettext, "errors", msg, opts)
    end
  end
